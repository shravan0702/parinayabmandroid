...
public class GetDropDownResponse implements Serializable {
    ...
    @Expose
    private ArrayList<Castedatum> castedata;
     ...
     * @param status
     */
    public GetDropDownResponse(List<Createdbydatum> createdbydata, String user, ArrayList<Castedatum> castedata, List<String> genderData, List<ReligionDatum> religionData, boolean status) {
        super();
    ...
    public GetDropDownResponse(boolean isMobile, String mobile, String email, List<Createdbydatum> createdbydata, String user, ArrayList<Castedatum> castedata, List<String> genderData, List<ReligionDatum> religionData, boolean status) {
    ...
    public ArrayList<Castedatum> getCastedata() {
        return castedata;
    }

    public void setCastedata(ArrayList<Castedatum> castedata) {
        this.castedata = castedata;
    }
    ...
    public class Createdbydatum implements Serializable
    {
         ...
         * @param status
         */
        public Createdbydatum(int id, String name, String status, String logDateCreated, long createdBy, String logDateModified, long modifiedBy) {
            super();
            this.id = id;
            this.name = name;
            this.status = status;
        ...
        public String toString() {
            ...
            sb.append(com.spacedevelopers.parinayabandham.about.Createdbydatum.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
            sb.append("id");
            sb.append('=');
            sb.append(this.id);
            sb.append(',');
    ...
    public class Castedatum {
        ...
        public Castedatum(int id, long religion, String casteName, String status, String createdAt, long createdBy, String updatedAt, long modifiedBy) {
            super();
            this.id = id;
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append(com.spacedevelopers.parinayabandham.about.Castedatum.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
            sb.append("id");
            sb.append('=');
            sb.append(this.id);
            sb.append(',');
    ...
    public  class ReligionDatum{
         ...
         * @param updatedAt
         */
        public ReligionDatum(int id, String religionName, String status, String createdAt, long createdBy, Object updatedAt, Object modifiedBy) {
            super();
            this.id = id;
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append(com.spacedevelopers.parinayabandham.about.ReligionDatum.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
            sb.append("id");
            sb.append('=');
            sb.append(this.id);
            sb.append(',');
